...
```
```{r}
levels(review$property_type)[!(levels(review$property_type) %in% prop_type)] <- rep("Other", times=12)
...
dim(train)
dim(sparse.model.matrix(~., train))
dim(sparse.model.matrix(~., review_test))
```
