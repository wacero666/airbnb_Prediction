...
write.csv(price_train, "price_train.csv")
price_val <- price_val[,-c(9,12,13,19)]
write.csv(price_val, "price_val.csv")
```
...
```{r}
cv.glmnet(y=price_train$price, x=as.matrix(price_train[,c(4,6,8,16)]), type.measure="mse", nfolds=5, alpha = 0.2)
```
