...
library(gridExtra)
 ...
 ggplot(data = price, aes(x = factor(room_type), y = price)) + geom_boxplot() + labs(x = "room_type", y="price") + ylim(0, 500)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggplot(data = price, aes(x = factor(bed_type), y = price)) + geom_boxplot() + labs(x = "bed_type", y="price") + ylim(0, 500)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggplot(data = price, aes(x = factor(instant_bookable), y = price)) + geom_boxplot() + labs(x = "instant_bookable", y="price") + ylim(0, 500)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggplot(data = price, aes(x = factor(cancellation_policy), y = price)) + geom_boxplot() + labs(x = "cancellation_policy", y="price") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
new_price <- price[,-c(9,12,13,19)]
write.csv(new_price, "new_price.csv")
```


```{r}
ggplot(data = new_price, aes(x = factor(total_nearby_landmarks), y = price)) + geom_boxplot() + labs(x = "total_nearby_landmarks", y="price") + ylim(0, 500)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
